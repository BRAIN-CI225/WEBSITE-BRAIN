-- ============================================================
-- BRAIN CMS - SETUP COMPLET DU BLOG (idempotent)
-- À exécuter EN UNE FOIS dans le SQL Editor du dashboard Supabase.
-- Étape 1 : production du module (communiquées exécution) :
--   1) table products + colonnes SEO/statut blog_posts + seed des 2 articles
--   2) seed des 5 nouveaux articles + alignement images ASSET/BLOG
-- Re-lancéable sans risque (IF NOT EXISTS / on conflict do nothing).
-- ============================================================
